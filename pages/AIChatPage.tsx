...
export const AIChatPage: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage = error.message || "An error occurred while connecting to the smart brain. Please check your connection or API configuration.";
      setMessages(prev => [...prev, {
        role: 'model',
        parts: [{ text: `⚠️ Connection Error: ${errorMessage}` }]
      }]);
    } finally {
      setIsLoading(false);
    }
